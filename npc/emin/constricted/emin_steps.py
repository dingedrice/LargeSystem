...
freeze = np.loadtxt("freeze_constricted.ndx", dtype=int) - 1
...
sbm_AA_grofile = 'constricted_dimer.gro'
sbm_AA_topfile = '/work/cms16/ed31/npc/constricted/SBM_L/openmm_del/constricted.top'
sbm_AA_xmlfile = '/work/cms16/ed31/npc/constricted/SBM_L/openmm_del/constricted.xml'
